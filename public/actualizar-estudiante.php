        ...
        <div id="content" class="main-content">
            ...
            <div class="row justify-content-center m-3">
                <div class="card col-12 col-md-11 col-lg-11">
                    ...
                    <form action="../php/actualizar-estudiante.php?usuario=<?php echo $usuario?>" method="post">
                        <div class="input-group mb-3">
                            <span class="input-group-text">Nombre</span>
                            <input type="text" class="form-control" name="input-nombre" value="<?php echo $rows["nombre"]?>">
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text">Apellido Paterno</span>
                            <input type="text" class="form-control" name="input-apellido1" value="<?php echo $rows["apellido1"]?>">
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text">Apellido Materno</span>
                            <input type="text" class="form-control" name="input-apellido2" value="<?php echo $rows["apellido2"]?>">
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text">Carrera</span>
                            <input type="text" class="form-control" name="input-carrera" value="<?php echo $rows["carrera"]?>">
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text">Correo</span>
                            <input type="text" class="form-control" name="input-correo" value="<?php echo $rows["correo"]?>">
                        </div>
                        <div class="input-group mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <textarea class="form-control" name="input-direccion"><?php echo $rows["domicilio"]?></textarea>
                        </div>
                        <div class="input-group mb-3">
                            <input type="file" class="form-control" name="input-img">
                        </div>
                        <div class="input-group mb-3">
                            <button type="guardar" class="btn form-control">Guardar</button>
                        </div>
                    </form>
                </div>
            </div>
